 ...
 * 1) Class.firName()의 리턴 값
 *   => forName()은 클래스를 로딩한 후 그 클래스 정보를 자룰 수 있는 객체(도구)를 리턴한다.
 *   
 * */
package step24;
...
//                           ㄴ>이자리에 어떤 입력값도 받을 수 있다. 그래서 현업에서 많이사용.
...
//       "?"의 의미: Class 도구가 다룰 수 있는 클래스는 아무거나 가능하다는 의미이다.
...
//    Class<?> c4 = Class.forName("step24.ClassTest01.MyClass"); 컴파일오류!
