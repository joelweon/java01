...
// Mybatis가 사용할 DB커넥션 관리자 (DataSource)
...
public class Test01_selectList {//마이바티스 함수 호출.
...
//    2. SQL을 실행할 SqlSession 객체를 생성한다.
    SqlSession sqlSession = sqlSessionFactory.openSession(); //new SqlSession()이 안된다.
                                                             //메서드
    
//    3. SELECT 문 실행
//     => selectList(SQL 맴퍼에 선언된 SQL문의 아이디)
//     => resultType 객체의 목록을 리턴한다.
