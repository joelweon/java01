...
public class Test05 {
  ...
  public static @interface MyAnnotation {
    int value(); // 기본 값을 지정하지 않으면 필수 입력항목이 된다.
    int value2() default 100; //기본값을 지정하면 선택 입력 항목이 된다.
  }
...
//    애노테이션의 프로퍼티 추출
    ...
    MyAnnotation anno2 = MyClass2.class.getAnnotation(MyAnnotation.class);//유지정책이 소스면 컴파일 할 떄 날아감
    System.out.println(anno2.value());
    System.out.println(anno2.value2()); // 기본값이 출력됨을 알 수 있다.
